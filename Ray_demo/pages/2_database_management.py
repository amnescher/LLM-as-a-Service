...
def upload_webpage(user_input, port, collection, name):
        ...
        response = requests.post(POST_URL)
        print('the response upload page: ', response, response.content)
...
with col1_2:
    ...
    if st.button('Remove document'):
              if selected_document is not None:
                    ...
                    print('collection name remove:', collection_rm, 'doc name remove:',doc_rm_name, type(collection_rm), type(doc_rm_name))
